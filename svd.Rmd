...
En el caso de 200 vs 0, es lo en terminos de norma aproximar primero una columna y luego la otra que hacer el promedio y compensar. Debe ser por "azar" que aproxima primero una entera y no hace el approach de poner el promedio.
